package com.osa.binance.api.client.security;
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (isSignatureRequired) {
            ...
            if (!StringUtils.isEmpty(payload)) {
                ...
                HttpUrl signedUrl = original.url().newBuilder().addQueryParameter(BinanceApiConstants.BINANCE_SIGN_PARAM, signature).build();
