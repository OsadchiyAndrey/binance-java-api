...
import com.osa.binance.api.client.domain.SwapRemoveType;
import com.osa.binance.api.client.domain.account.Liquidity;
import com.osa.binance.api.client.domain.account.LiquidityOperationRecord;
...
import static com.osa.binance.api.client.impl.BinanceApiServiceProducer.executeSync;
...
public class BinanceApiSwapRestClientImpl implements BinanceApiSwapRestClient {
    ...
    public BinanceApiSwapRestClientImpl(BinanceConfig binanceConfig) {
        binanceApiService = createService(BinanceApiService.class, binanceConfig);
    }
